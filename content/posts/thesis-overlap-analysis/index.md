...
*Updated 25 July 2026, after a six-encoder replication: the shared-run count is now exact and encoder-free (179 pairs, previously 67), the extent estimate rises to roughly 7,000–11,000 words after an estimator correction, and the within- versus cross-document comparison is stated in its conditional form. Replication code is attached in §7.*
